  ...
  <body class="bg-light">
        ...
        <div class="modal-content">
          <form>
            ...
            <div class="modal-body">
              ...
              <div
                class="d-flex aling-items-center justify-content-between md-2"
              >
    ...
    <div class="container">
      <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
        ...
        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
          <img src="images/facilities/water_heater.svg" width="80px">
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide  bg-white p-4">
        <div class="profile d-flex align-items-center mb-3">
          <img src="images/facilities/wifi.svg" width="30ox">
          <h6 class="m-0 ms-2">Randowm user1</h6>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis consequatur enim numquam, sint officiis excepturi maxime? Impedit eum ea fugit.</p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
